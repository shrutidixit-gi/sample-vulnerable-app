...
def get_user(username):
    # FIX: SQL injection remediated - using parameterized query instead of string formatting
    # Parameterized queries prevent SQL injection by separating SQL logic from user input
